...
var parseData = function(arr){
	...
	for(var i = 0;i<arr.length;i++){
		// find the index of '-' in the date value, assign the to a var DASH
		var dashString = arr[i].start.local + '';
		

		var dashIndex = dashString.indexOf('–'); // – is a special dash call en dash. ascii 8211
		// console.log('en dash, are you here?', arr[i].start.local.indexOf('–'));
		var strLen = arr[i].start.local.length-1;

		// assign the time string to the index DASH+1 to send of string
		arr[i].time = arr[i].start.local.substr(dashIndex+1, strLen);
		
		// assign the start string to the index 0-DASH-1
		arr[i].start.local = arr[i].start.local.substr(0, dashIndex-1);
...
// var enDashIndex = function(str){
// 	var enDash = charAt(8211);
// 	console.log(enDash);
...
// 	}
	...
	// for(var i = 0;i<arr.length;i++){
	// 	var flag = 0;
	// 	for(var j = arr[i].start.local; j > 0; j--){ // iterate through the string backwards
	// 		// find the first space, switch flag
	// 		if()
	// 		// find the second space, return the index
...
var data = [ { name: { text: 'People in Plazas: Free R&B Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-rb-concert-sf-2/',
    city: 'San Francisco',
  ...
  { name: { text: 'People in Plazas: Free Jazz/Blues Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-jazzblues-concert-sf-2/',
    city: 'San Francisco',
    date: 'Tuesday, September 22 – 12:00 pm',
    cost: 'FREE' },
  { name: { text: 'People in Plazas: Free R&B Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-rb-concert-sf-3/',
    city: 'San Francisco',
  ...
  { name: { text: 'Union Square Live Psychedelic Music: Moonalice ' },
    ...
    url: 'http://sf.funcheap.com/union-square-live-psychedelic-music-moonalice-sf-2/',
    city: 'San Francisco',
  ...
  { name: { text: 'September Wednesdays Jazz Fest ' },
    ...
    url: 'http://sf.funcheap.com/september-wednesdays-jazz-fest-oakland-3/',
    city: 'Oakland',
    date: 'Wednesday, September 23 – 6:00 pm',
    cost: 'FREE' },
  { name: { text: 'Music in the Park: Soul Concert ' },
    ...
    url: 'http://sf.funcheap.com/music-park-soul-concert-albany/',
    city: 'Albany',
    date: 'Wednesday, September 23 – 6:30 pm',
    cost: 'FREE' },
  { name: { text: 'Win Tix: Sterolab’s “Laetita Sadier” Indie Solo Show ' },
    description: { text: '' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/09/XgPqVOs1-175x130.jpg' },
    venue: { name: ' Brick & Mortar Music Hall ' },
    url: 'http://sf.funcheap.com/indierock-musician-laetita-sadier-brick-mortar/',
    city: 'Brick and Mortar',
    date: 'Wednesday, September 23 – 8:00 pm',
    cost: 'WIN' },
  { name: { text: 'Win Tix: Seoul: Fun, Folk Montreal Dream Pop Trio ' },
    ...
    url: 'http://sf.funcheap.com/seoul-fun-folk-montreal-dream-pop-trio-bottom-hill/',
  ...
  { name: { text: 'People in Plazas: Free Jazz Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-jazz-concert-sf-2/',
    city: 'San Francisco',
  ...
  { name: { text: 'Old Blues, Pop & Jazz Music Show ' },
    ...
    url: 'http://sf.funcheap.com/blues-pop-jazz-music-show-yerba-buena-gardens-festival/',
  ...
  { name: { text: 'People in Plazas: Free Reggae Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-reggae-concert-sf/',
    city: 'San Francisco',
    date: 'Thursday, September 24 – 12:30 pm',
    cost: 'FREE' },
  { name: { text: 'Live Music Happy Hour Under the Dome ' },
    ...
    url: 'http://sf.funcheap.com/live-music-happy-hour-under-the-dome-westfield-sf-2/',
    city: 'Westfield SF',
  ...
  { name: { text: '“Off The Grid” Twilight Campfire Party ' },
    ...
    url: 'http://sf.funcheap.com/off-the-grid-twilight-campfire-party-presidio-36/',
    city: 'Presidio',
    date: 'Thursday, September 24 – 4:00 pm',
    cost: 'FREE' },
  { name: { text: 'Rhythm & Blues Concert: Vintage Trouble ' },
    ...
    url: 'http://sf.funcheap.com/rhythm-blues-concert-vintage-trouble-sf/',
    city: 'San Francisco',
  ...
  { name: { text: 'Beer Friday: Live Music, Food Trucks & Family Party ' },
    ...
    url: 'http://sf.funcheap.com/beer-friday-live-music-food-trucks-family-party-san-carlos-15/',
    city: 'San Carlos',
  ...
  { name: { text: 'People in Plazas: Free Swing Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-swing-concert-sf/',
    city: 'San Francisco',
  ...
  { name: { text: 'People in Plazas: Free Cuban Salsa Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-cuban-salsa-concert-sf/',
    city: 'San Francisco',
    date: 'Friday, September 25 – 12:00 pm',
    cost: 'FREE' },
  { name: { text: 'People in Plazas: Free New Orleans Blues Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-orleans-blues-concert-sf/',
    city: 'San Francisco',
    date: 'Friday, September 25 – 12:00 pm',
    cost: 'FREE' },
  { name: { text: 'Friday Night Market at UN Plaza ' },
    ...
    venue: { name: ' UN Plaza ' },
    url: 'http://sf.funcheap.com/friday-night-market-at-un-plaza-sf-2/',
    city: 'San Francisco',
  ...
  { name: { text: '“Off the Grid” Friday Night Food Truck Party ' },
    ...
    url: 'http://sf.funcheap.com/off-the-grid-friday-night-food-truck-party-fort-mason-88/',
    city: 'Fort Mason',
    date: 'Friday, September 25 – 5:00 pm',
    cost: 'FREE' },
  { name: { text: 'Point Richmond Concert: Soji & The Afrobeat Band ' },
    ...
    url: 'http://sf.funcheap.com/point-richmond-concert-soji-afrobeat-band-east-bay/',
    city: 'East Bay',
  ...
  { name: { text: 'Candle Lit Labyrinth Walk & Live Music ' },
    ...
    url: 'http://sf.funcheap.com/candle-lit-labyrinth-walk-live-music-berkeley-20/',
    city: 'Berkeley',
  ...
  { name: { text: 'Free Vegetarian Dinner Night ' },
    ...
    url: 'http://sf.funcheap.com/free-vegetarian-dinner-night-sf-20/',
    city: 'San Francisco',
    date: 'Friday, September 25 – 6:00 pm',
    cost: 'FREE' },
  { name: { text: 'Feral Fourth Fridays Urban Square Dance & Live Music ' },
    ...
    url: 'http://sf.funcheap.com/feral-fourth-fridays-urban-square-dance-live-music-sf-8/',
    city: 'San Francisco',
  ...
  { name: { text: 'Live Music: La Mandanga ' },
    ...
    url: 'http://sf.funcheap.com/live-music-la-mandanga-berkeley/',
    city: 'Berkeley',
  ...
  { name: { text: 'The Beatles Choir: Volunteer Singalong ' },
    ...
    url: 'http://sf.funcheap.com/the-beatles-choir-volunteer-singalong-sf-18/',
    city: 'San Francisco',
  ...
  { name: { text: '2015 Bay Area Blues Festival: Saturday ' },
    ...
    url: 'http://sf.funcheap.com/blues-festival-saturday/',
    city: 'East Bay',
  ...
  { name: { text: '20th Annual Watershed Environmental Poetry Festival ' },
    ...
    url: 'http://sf.funcheap.com/watershed-environmental-poetry-festival-berkeley-2/',
    city: 'Berkeley',
    date: 'Saturday, September 26 – All Day',
    cost: 'FREE' },
  { name: { text: '“CykelScramble” Clif Bar Bike Fest, Relay Race & Cold War Kids Concert ' },
    description: { text: '' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/09/o-COLD-WAR-KIDS-THE-METRO-CHICAGO-facebook-175x130.jpg' },
    venue: { name: ' Marin County Fairgrounds ' },
    url: 'http://sf.funcheap.com/cykelscramble-bike-fest-cold-war-kids-geographer/',
    city: 'Marin',
    date: 'Saturday, September 26 – All Day',
    cost: 'FREE' },
  { name: { text: 'Win Tix: Persian Pop-Classical Concert: NeekOn 2015 Festival ' },
    ...
    url: 'http://sf.funcheap.com/persian-popclassical-concert-neekon-2015-festival-de-young-museum/',
  ...
  { name: { text: '2015 OktoberFest: Live Bavarian Music, Dancing, Food & Beer ' },
    ...
    url: 'http://sf.funcheap.com/newark-oktoberfest-2015-swiss-park/',
    city: 'Newark',
  ...
  { name: { text: '“Sketchboard”: Figure Drawing Art Class & Live Music ' },
    ...
    url: 'http://sf.funcheap.com/sketchboard-figure-drawing-art-class-live-music-the-haight-3/',
    city: 'The Haight',
    date: 'Saturday, September 26 – 2:00 pm',
    cost: '$5*' },
  { name: { text: 'Free Benefit Concert for Habitat for Humanity ' },
    description: { text: '' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/09/Brett_band1-175x130.png' },
    venue: { name: ' Grace Presbyterian Church ' },
    url: 'http://sf.funcheap.com/free-benefit-concert-habitat-humanity-walnut-creek/',
    city: 'Walnut Creek',
    date: 'Saturday, September 26 – 2:00 pm',
    cost: 'FREE' },
  { name: { text: 'Danish Pop Mini Concert: Mew ' },
    ...
    venue: { name: ' Amoeba Music (SF) ' },
    url: 'http://sf.funcheap.com/danish-pop-mini-concert-mew-sf/',
    city: 'San Francisco',
    date: 'Saturday, September 26 – 2:00 pm',
    cost: 'FREE' },
  { name: { text: '2015 Bay Area Blues Festival: Sunday ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2012/08/polk-blues-175x130.jpg' },
    venue: { name: ' Downtown Martinez ' },
    url: 'http://sf.funcheap.com/bay-area-blues-festival-sunday/',
    city: 'East Bay',
  ...
  { name: { text: 'Sunday Assembly: Communty Sing & Meetup ' },
    ...
    url: 'http://sf.funcheap.com/sunday-assembly-communty-sing-meetup-oakland-2/',
    city: 'Oakland',
  ...
  { name: { text: 'Off the Grid: Presidio Picnic & Food Truck Party ' },
    ...
    venue: { name: ' Main Post Lawn ' },
    url: 'http://sf.funcheap.com/off-the-grid-presidio-picnic-food-truck-party-sf-84/',
    city: 'San Francisco',
    date: 'Sunday, September 27 – 11:00 am',
    cost: 'FREE' },
  { name: { text: 'Live Jazz Music: Faye Carol ' },
    ...
    url: 'http://sf.funcheap.com/live-jazz-music-faye-carol-sf/',
    city: 'San Francisco',
  ...
  { name: { text: '“A Prison Oratorio” American Culture Musical ' },
    ...
    venue: { name: ' Yerba Buena Gardens (Esplanade) ' },
    url: 'http://sf.funcheap.com/prison-oratorio-american-culture-musical-yerba-buena-gardens-festival/',
    city: 'Yerba Buena Gardens Festival',
    date: 'Sunday, September 27 – 1:00 pm',
    cost: 'FREE' },
  { name: { text: 'Jazz at the Park ' },
    ...
    url: 'http://sf.funcheap.com/jazz-park-sf/',
  ...
  { name: { text: 'People in Plazas: Free Jazz/Blues Concert ' },
    ...
    venue: { name: ' Jane Warner Memorial Plaza ' },
    url: 'http://sf.funcheap.com/people-plazas-free-jazzblues-concert-sf/',
    city: 'San Francisco',
    date: 'Sunday, September 27 – 1:00 pm',
    cost: 'FREE' },
  { name: { text: 'Summer Outdoor Music Series ' },
    ...
    url: 'http://sf.funcheap.com/summer-outdoor-music-series-corte-madera-15/',
    city: 'Corte Madera',
  ...
  { name: { text: 'Live Music: Gutter Swan & Steve Egelman ' },
    ...
    url: 'http://sf.funcheap.com/live-music-gutter-swan-steve-egelman-sf/',
    city: 'San Francisco',
  ...
  { name: { text: 'Original Famous Twang Sundays: Live Country Music ' },
    ...
    url: 'http://sf.funcheap.com/original-famous-twang-sundays-live-country-music-potrero-hill-88/',
    city: 'Potrero Hill',
    date: 'Sunday, September 27 – 4:00 pm',
    cost: 'FREE' },
  { name: { text: '“Return of the Cypher” Hip-Hop & Beatbox Jam ' },
    ...
    url: 'http://sf.funcheap.com/return-of-the-cypher-hip-hop-beatbox-jam-boom-boom-room-102/',
    city: 'Boom Boom Room',
  ...
  { name: { text: 'People in Plazas: Free Smooth Jazz Concert ' },
    ...
    venue: { name: ' Rincon Center ' },
    url: 'http://sf.funcheap.com/people-plazas-free-smooth-jazz-concert-sf/',
    city: 'San Francisco',
  ...
  { name: { text: 'People in Plazas: Free Gypsy Jazz Concert ' },
    ...
    venue: { name: ' Mechanics Monument Plaza ' },
    url: 'http://sf.funcheap.com/people-plazas-free-gypsy-jazz-concert-sf-3/',
    city: 'San Francisco',
    date: 'Tuesday, September 29 – 12:00 pm',
    cost: 'FREE' },
  { name: { text: 'People in Plazas: Free Steel Drum Concert ' },
    ...
    venue: { name: ' Civic Center Plaza ' },
    url: 'http://sf.funcheap.com/people-plazas-free-steel-drum-concert-sf/',
    city: 'San Francisco',
  ...
  { name: { text: 'People in Plazas: Free Salsa Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-salsa-concert-sf/',
    city: 'San Francisco',
    date: 'Wednesday, September 30 – 12:00 pm',
    cost: 'FREE' },
  { name: { text: 'September Wednesdays Jazz Fest ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/08/jazz-band-175x130.jpg' },
    venue: { name: ' Ozumo Oakland ' },
    url: 'http://sf.funcheap.com/september-wednesdays-jazz-fest-oakland-4/',
    city: 'Oakland',
  ...
  { name: { text: 'Music in the Park: Michael Jackson Tribute Concert ' },
    ...
    venue: { name: ' Memorial Park (Albany) ' },
    url: 'http://sf.funcheap.com/music-park-michael-jackson-tribute-concert-albany/',
    city: 'Albany',
  ...
  { name: { text: 'People in Plazas: Free Americana Concert ' },
    ...
    venue: { name: ' Transamerica Redwood Park ' },
    url: 'http://sf.funcheap.com/people-plazas-free-americana-concert-sf-2/',
    city: 'San Francisco',
  ...
  { name: { text: 'Chadly & Abdelhadi North African Music ' },
    ...
    venue: { name: ' Yerba Buena Gardens (Esplanade) ' },
    url: 'http://sf.funcheap.com/chadly-abdelhadi-north-african-music-yerba-buena-gardens-festival/',
    city: 'Yerba Buena Gardens Festival',
  ...
  { name: { text: 'People in Plazas: Free Jazz Vocals Concert ' },
    ...
    venue: { name: ' Mint Plaza ' },
    url: 'http://sf.funcheap.com/people-plazas-free-jazz-vocals-concert-sf/',
    city: 'San Francisco',
    date: 'Thursday, October 1 – 12:30 pm',
    cost: 'FREE' },
  { name: { text: '“Off The Grid” Twilight Campfire Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/09/1495157_542562532525614_897471763_o1-175x130.jpg' },
    venue: { name: ' Main Post Lawn ' },
    url: 'http://sf.funcheap.com/off-the-grid-twilight-campfire-party-presidio-37/',
    city: 'Presidio',
    date: 'Thursday, October 1 – 4:00 pm',
    cost: 'FREE' },
  { name: { text: 'Art Night SF: Mid-Market Art & Live Music ' },
    description: { text: 'Art Night SF is a new outdoor event series working to activate the public spaces of UN Plaza and Mid-Market between 7th and Market Streets through accessible installations of contemporary art on September 17, October 1 and October 22, 2015 from 5-9 pm. Enjoy local food ...' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/09/11846558_988753431155046_1951424086643602062_n-175x130.jpg' },
    venue: { name: ' UN Plaza ' },
    url: 'http://sf.funcheap.com/art-night-sf-midmarket-art-performance-series-plaza-2/',
    city: 'UN Plaza',
    date: 'Thursday, October 1 – 5:00 pm',
    cost: 'FREE' },
  { name: { text: '1st & 3rd Thursday “Hub CAP” Community Art Party ' },
    ...
    url: 'http://sf.funcheap.com/1st-3rd-thursday-hub-cap-community-art-party-vallejo-7/',
    city: 'Vallejo',
  ...
  { name: { text: 'Hardly Strictly Bluegrass 2015: Friday ' },
    ...
    url: 'http://sf.funcheap.com/strictly-bluegrass-friday-ggpark/',
  ...
  { name: { text: 'People in Plazas: Free Hawaiian Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-hawaiian-concert-sf/',
    city: 'San Francisco',
  ...
  { name: { text: 'People in Plazas: Free Blues Concert ' },
    ...
    venue: { name: ' 201 Spear Street ' },
    url: 'http://sf.funcheap.com/people-plazas-free-blues-concert-sf-2/',
    city: 'San Francisco',
    date: 'Friday, October 2 – 12:00 pm',
    cost: 'FREE' },
  { name: { text: 'People in Plazas: Free Brazilian Concert ' },
    ...
    venue: { name: ' 101 California ' },
    url: 'http://sf.funcheap.com/people-plazas-free-brazilian-concert-sf/',
    city: 'San Francisco',
    date: 'Friday, October 2 – 12:00 pm',
    cost: 'FREE' },
  { name: { text: 'People in Plazas: Free Gypsy Jazz Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-gypsy-jazz-concert-sf-2/',
    city: 'San Francisco',
    date: 'Friday, October 2 – 12:00 pm',
    cost: 'FREE' },
  { name: { text: '“Off the Grid” Friday Night Food Truck Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/03/otg-175x130.jpeg' },
    venue: { name: ' Fort Mason Center ' },
    url: 'http://sf.funcheap.com/off-the-grid-friday-night-food-truck-party-fort-mason-89/',
    city: 'Fort Mason',
  ...
  { name: { text: 'South First Fridays Art Walk ' },
    ...
    url: 'http://sf.funcheap.com/south-first-fridays-art-walk-san-jose-29/',
    city: 'San Jose',
  ...
  { name: { text: '“Wrapped in Plastic” Jazz Quartet ' },
    ...
    url: 'http://sf.funcheap.com/wrapped-in-plastic-jazz-quartet-the-royale-19/',
    city: 'The Royale',
  ...
  { name: { text: 'Hardly Strictly Bluegrass 2015: Saturday ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2011/09/bluegrass-oct-31-175x130.jpg' },
    venue: { name: ' Hellman Hollow ' },
    url: 'http://sf.funcheap.com/strictly-bluegrass-saturday-golden-gate-park-2/',
    city: 'Golden Gate Park',
  ...
  { name: { text: '21st Century Jazz Concert ' },
    ...
    venue: { name: ' Yerba Buena Gardens (Esplanade) ' },
    url: 'http://sf.funcheap.com/live-21st-centure-jazz-concert-yerba-buena-gardens-festival/',
    city: 'Yerba Buena Gardens Festival',
  ...
  { name: { text: 'Sea Chantey Sing Along Aboard Historic Ship ' },
    ...
    url: 'http://sf.funcheap.com/sea-chantey-sing-along-aboard-historic-ship-sf-25/',
    city: 'San Francisco',
  ...
  { name: { text: 'Push The Feeling DJ Night ' },
    ...
    url: 'http://sf.funcheap.com/push-the-feeling-dj-night-lower-haight-26/',
    city: 'Lower Haight',
  ...
  { name: { text: 'Hardly Strictly Bluegrass 2015: Sunday ' },
    ...
    venue: { name: ' Hellman Hollow ' },
    url: 'http://sf.funcheap.com/strictly-bluegrass-sunday-golden-gate-park-2/',
    city: 'Golden Gate Park',
  ...
  { name: { text: 'Grande Finale: All Request Program ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2011/04/Golden-Gate-Park-Band1-175x130.jpg' },
    venue: { name: ' Spreckels Temple of Music ' },
    url: 'http://sf.funcheap.com/grande-finale-request-program-sf/',
    city: 'Golden Gate Park Band',
  ...
  { name: { text: 'Original Famous Twang Sundays: Live Country Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/06/original-twang-175x130.png' },
    venue: { name: ' Thee Parkside ' },
    url: 'http://sf.funcheap.com/original-famous-twang-sundays-live-country-music-potrero-hill-93/',
    city: 'Potrero Hill',
    date: 'Sunday, October 4 – 4:00 pm',
    cost: 'FREE' },
  { name: { text: '“Return of the Cypher” Hip-Hop & Beatbox Jam ' },
    description: { text: 'Return of the Cypher (ROTC) is free live Hip-Hop show every Sunday at the Boom Boom Room that features an ever-changing lineup of artists and improvised sessions (know as “cyphers”) where beatboxers, emcees, and musicians collaborate in a spontaneous combustion of soulful skill. Every week, The ...' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/07/rotc-175x130.jpg' },
    venue: { name: ' Boom Boom Room ' },
    url: 'http://sf.funcheap.com/return-of-the-cypher-hip-hop-beatbox-jam-boom-boom-room-103/',
    city: 'Boom Boom Room',
  ...
  { name: { text: 'Free First Monday Concert ' },
    ...
    url: 'http://sf.funcheap.com/free-first-monday-concert-make-out-room-19/',
    city: 'Make-Out Room',
  ...
  { name: { text: 'Beatles Karaoke Night ' },
    ...
    venue: { name: ' The Royale ' },
    url: 'http://sf.funcheap.com/beatles-karaoke-night-trendynob-30/',
    city: 'Trendynob',
    date: 'Monday, October 5 – 8:00 pm',
    cost: 'FREE' },
  { name: { text: 'Open Mic Night in a Movie Theater ' },
    ...
    url: 'http://sf.funcheap.com/open-mic-night-in-a-movie-theater-the-new-parkway-4/',
  ...
  { name: { text: 'Wood Shoppe Free Concert Series ' },
    ...
    venue: { name: ' Brick & Mortar Music Hall ' },
    url: 'http://sf.funcheap.com/wood-shoppe-free-concert-series-brick-mortar-29/',
    city: 'Brick & Mortar',
  ...
  { name: { text: '“Off The Grid” Twilight Campfire Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/09/1495157_542562532525614_897471763_o1-175x130.jpg' },
    venue: { name: ' Main Post Lawn ' },
    url: 'http://sf.funcheap.com/off-the-grid-twilight-campfire-party-presidio-38/',
    city: 'Presidio',
  ...
  { name: { text: '“Off the Grid” Friday Night Food Truck Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/03/otg-175x130.jpeg' },
    venue: { name: ' Fort Mason Center ' },
    url: 'http://sf.funcheap.com/off-the-grid-friday-night-food-truck-party-fort-mason-90/',
    city: 'Fort Mason',
  ...
  { name: { text: 'Free Veggie Dinner Night ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/12/volxkuche-175x130.jpg' },
    venue: { name: ' St. John Episcopal Church ' },
    url: 'http://sf.funcheap.com/free-veggie-dinner-night-sf-20/',
    city: 'San Francisco',
  ...
  { name: { text: '“She Rocks” Live Music, Comedy & Drag Showcase ' },
    ...
    url: 'http://sf.funcheap.com/she-rocks-live-music-comedy-drag-showcase-sf-9/',
    city: 'San Francisco',
  ...
  { name: { text: 'Saturday Children’s Festival in the Park ' },
    ...
    url: 'http://sf.funcheap.com/saturday-childrens-festival-park-mclaren-park/',
    city: 'McLaren Park',
  ...
  { name: { text: 'Downtown Campbell Second Saturdays: Music, Art & Food' },
    ...
    url: 'http://sf.funcheap.com/downtown-campbell-second-saturdays-music-art-food-23/',
    city: undefined,
  ...
  { name: { text: 'Original Famous Twang Sundays: Live Country Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/06/original-twang-175x130.png' },
    venue: { name: ' Thee Parkside ' },
    url: 'http://sf.funcheap.com/original-famous-twang-sundays-live-country-music-potrero-hill-94/',
    city: 'Potrero Hill',
    date: 'Sunday, October 11 – 4:00 pm',
    cost: 'FREE' },
  { name: { text: 'Shapeshifters Cinema: Experimental Film & Music ' },
    ...
    url: 'http://sf.funcheap.com/shapeshifters-cinema-experimental-film-music-oakland-26/',
    city: 'Oakland',
  ...
  { name: { text: '“Return of the Cypher” Hip-Hop & Beatbox Jam ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/07/rotc-175x130.jpg' },
    venue: { name: ' Boom Boom Room ' },
    url: 'http://sf.funcheap.com/return-of-the-cypher-hip-hop-beatbox-jam-boom-boom-room-104/',
    city: 'Boom Boom Room',
  ...
  { name: { text: 'Wheel of Karaoke: Comedy & Music Battle ' },
    ...
    venue: { name: ' Make-Out Room ' },
    url: 'http://sf.funcheap.com/wheel-of-karaoke-comedy-music-battle-make-out-room-13/',
    city: 'Make-Out Room',
  ...
  { name: { text: 'Litquake: Outdoor Poetry & Music ' },
    ...
    url: 'http://sf.funcheap.com/litquake-outdoor-poetry-music-yerba-buena-gardens-festival/',
    city: 'Yerba Buena Gardens Festival',
  ...
  { name: { text: 'San Francisco Music Video Mini-Fest ' },
    ...
    url: 'http://sf.funcheap.com/san-francisco-music-video-minifest-bazaar-cafe-2/',
    city: 'Bazaar Cafe',
  ...
  { name: { text: '“Off The Grid” Twilight Campfire Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/09/1495157_542562532525614_897471763_o1-175x130.jpg' },
    venue: { name: ' Main Post Lawn ' },
    url: 'http://sf.funcheap.com/off-the-grid-twilight-campfire-party-presidio-39/',
    city: 'Presidio',
    date: 'Thursday, October 15 – 4:00 pm',
    cost: 'FREE' },
  { name: { text: 'Third Thursday Piedmont Avenue Stroll ' },
    description: { text: 'At the Piedmont Avenue Stroll you can expect to see a variety of art mediums, enjoy entertainment, and sample refreshments with many businesses showcasing hand-picked local artists and designers. The monthly event was voted Best Art Walk That’s Not Art Murmur by the East Bay Express, ...' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2012/11/piedmont-avenue-175x130.jpg' },
    venue: { name: ' Piedmont Avenue ' },
    url: 'http://sf.funcheap.com/third-thursday-piedmont-avenue-stroll-oakland-28/',
    city: 'Oakland',
  ...
  { name: { text: 'Hardly Strictly Tribute Concert Series ' },
    ...
    url: 'http://sf.funcheap.com/hardly-strictly-tribute-concert-series-contemporary-jewish-museum-3/',
  ...
  { name: { text: '“3rd On Third” Arts & Music ' },
    ...
    url: 'http://sf.funcheap.com/3rd-on-third-arts-music-bayview-22/',
    city: 'Bayview',
  ...
  { name: { text: '“Off the Grid” Friday Night Food Truck Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/03/otg-175x130.jpeg' },
    venue: { name: ' Fort Mason Center ' },
    url: 'http://sf.funcheap.com/off-the-grid-friday-night-food-truck-party-fort-mason-91/',
    city: 'Fort Mason',
    date: 'Friday, October 16 – 5:00 pm',
    cost: 'FREE' },
  { name: { text: 'Saturday Blues Concert in the Park ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/08/jerry-garcia-amphitheatre-175x130.jpg' },
    venue: { name: ' Jerry Garcia Amphitheatre (McLaren Park) ' },
    url: 'http://sf.funcheap.com/saturday-blues-concert-park-mclaren-park/',
    city: 'McLaren Park',
  ...
  { name: { text: 'Inner Sunset Sundays 2015 ' },
    ...
    url: 'http://sf.funcheap.com/sunset-sundays-block-party-street-fair-2/',
  ...
  { name: { text: '“Eats, Beats & Brews” Block Party: Salsa Dancing, Games & Beer Garden ' },
    ...
    url: 'http://sf.funcheap.com/eats-beats-brews-block-party-salsa-dancing-games-beer-garden-berkeley-5/',
    city: 'Berkeley',
    date: 'Sunday, October 18 – All Day',
    cost: 'FREE' },
  { name: { text: 'Original Famous Twang Sundays: Live Country Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/06/original-twang-175x130.png' },
    venue: { name: ' Thee Parkside ' },
    url: 'http://sf.funcheap.com/original-famous-twang-sundays-live-country-music-potrero-hill-95/',
    city: 'Potrero Hill',
    date: 'Sunday, October 18 – 4:00 pm',
    cost: 'FREE' },
  { name: { text: '“Return of the Cypher” Hip-Hop & Beatbox Jam ' },
    description: { text: 'Return of the Cypher (ROTC) is free live Hip-Hop show every Sunday at the Boom Boom Room that features an ever-changing lineup of artists and improvised sessions (know as “cyphers”) where beatboxers, emcees, and musicians collaborate in a spontaneous combustion of soulful skill. Every week, The ...' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/07/rotc-175x130.jpg' },
    venue: { name: ' Boom Boom Room ' },
    url: 'http://sf.funcheap.com/return-of-the-cypher-hip-hop-beatbox-jam-boom-boom-room-105/',
    city: 'Boom Boom Room',
  ...
  { name: { text: '“Off The Grid” Twilight Campfire Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/09/1495157_542562532525614_897471763_o1-175x130.jpg' },
    venue: { name: ' Main Post Lawn ' },
    url: 'http://sf.funcheap.com/off-the-grid-twilight-campfire-party-presidio-40/',
    city: 'Presidio',
  ...
  { name: { text: 'Art Night SF: Mid-Market Art & Live Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/09/11846558_988753431155046_1951424086643602062_n-175x130.jpg' },
    venue: { name: ' UN Plaza ' },
    url: 'http://sf.funcheap.com/art-night-sf-midmarket-art-performance-series-plaza-3/',
    city: 'UN Plaza',
    date: 'Thursday, October 22 – 5:00 pm',
    cost: 'FREE' },
  { name: { text: 'Friday Night Market at UN Plaza ' },
    description: { text: 'Held every fourth Friday through October, the Night Market in the iconic UN Plaza is the place to spend your Friday night. Night Market provides live music and entertainment, making the UN Plaza the liveliest spot in the city. The Night Market is a free ...' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/07/2015-Night-Market-Web-Thumbnail-175x130.jpg' },
    venue: { name: ' UN Plaza ' },
    url: 'http://sf.funcheap.com/friday-night-market-at-un-plaza-sf-3/',
    city: 'San Francisco',
  ...
  { name: { text: '“Off the Grid” Friday Night Food Truck Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/03/otg-175x130.jpeg' },
    venue: { name: ' Fort Mason Center ' },
    url: 'http://sf.funcheap.com/off-the-grid-friday-night-food-truck-party-fort-mason-92/',
    city: 'Fort Mason',
    date: 'Friday, October 23 – 5:00 pm',
    cost: 'FREE' },
  { name: { text: 'Free Vegetarian Dinner Night ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/12/volxkuche-175x130.jpg' },
    venue: { name: ' St. John Episcopal Church ' },
    url: 'http://sf.funcheap.com/free-vegetarian-dinner-night-sf-21/',
    city: 'San Francisco',
  ...
  { name: { text: 'Feral Fourth Fridays Urban Square Dance & Live Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/01/nat_geo__0706_shall_we_dance-175x130.jpg' },
    venue: { name: ' Alley Cat Books ' },
    url: 'http://sf.funcheap.com/feral-fourth-fridays-urban-square-dance-live-music-sf-6/',
    city: 'San Francisco',
  ...
  { name: { text: 'The Beatles Choir: Volunteer Singalong ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/12/beatles-choir-175x130.jpg' },
    venue: { name: ' Laguna Honda Hospital ' },
    url: 'http://sf.funcheap.com/the-beatles-choir-volunteer-singalong-sf-19/',
    city: 'San Francisco',
    date: 'Saturday, October 24 – 9:30 am',
    cost: 'FREE' },
  { name: { text: 'Sunday Assembly: Communty Sing & Meetup ' },
    description: { text: 'Sunday Assembly is a non-religious congregation that celebrates life. They’ve got the best parts of a church – community, singing, and acts of service – without any of the religious dogma. They typically meet on the fourth Sunday of the month to sing, think, listen, laugh, ...' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2014/03/SA_FB_Cover_Wonder_Audience1-175x130.jpg' },
    venue: { name: ' Oakland Peace Center ' },
    url: 'http://sf.funcheap.com/sunday-assembly-communty-sing-meetup-oakland-3/',
    city: 'Oakland',
  ...
  { name: { text: 'Mixed Media Mixer: Art, Music, Photo & Video Showcase ' },
    ...
    url: 'http://sf.funcheap.com/mixed-media-mixer-art-music-photo-video-showcase-berkeley-22/',
    city: 'Berkeley',
  ...
  { name: { text: 'Original Famous Twang Sundays: Live Country Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/06/original-twang-175x130.png' },
    venue: { name: ' Thee Parkside ' },
    url: 'http://sf.funcheap.com/original-famous-twang-sundays-live-country-music-potrero-hill-96/',
    city: 'Potrero Hill',
    date: 'Sunday, October 25 – 4:00 pm',
    cost: 'FREE' },
  { name: { text: 'People in Plazas: Free Afro-Cuban Concert ' },
    ...
    url: 'http://sf.funcheap.com/people-plazas-free-afrocuban-concert-sf/',
    city: 'San Francisco',
  ...
  { name: { text: '2015 “Best of Bernal” Film Night, Reception & Music ' },
    ...
    url: 'http://sf.funcheap.com/bernal-heights-outdoor-cinema-filmmaker-reception/',
    city: 'San Francisco',
  ...
  { name: { text: '“Off The Grid” Twilight Campfire Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/09/1495157_542562532525614_897471763_o1-175x130.jpg' },
    venue: { name: ' Main Post Lawn ' },
    url: 'http://sf.funcheap.com/off-the-grid-twilight-campfire-party-presidio-41/',
    city: 'Presidio',
  ...
  { name: { text: 'Beer Friday: Live Music, Food Trucks & Family Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/02/Devils_Canyon_Brewing_Company_2-1-175x130.jpg' },
    venue: { name: ' Devil\'s Canyon Brewing Company ' },
    url: 'http://sf.funcheap.com/beer-friday-live-music-food-trucks-family-party-san-carlos-16/',
    city: 'San Carlos',
  ...
  { name: { text: '“Off the Grid” Friday Night Food Truck Party ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/03/otg-175x130.jpeg' },
    venue: { name: ' Fort Mason Center ' },
    url: 'http://sf.funcheap.com/off-the-grid-friday-night-food-truck-party-fort-mason-93/',
    city: 'Fort Mason',
  ...
  { name: { text: '“Sketchboard”: Figure Drawing Art Class & Live Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/05/600_87886042-175x130.jpeg' },
    venue: { name: ' The Red Victorian ' },
    url: 'http://sf.funcheap.com/sketchboard-figure-drawing-art-class-live-music-the-haight-4/',
    city: 'The Haight',
  ...
  { name: { text: 'Free First Monday Concert ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2012/11/481143_433285450057196_1264585988_n-175x130.jpg' },
    venue: { name: ' Make-Out Room ' },
    url: 'http://sf.funcheap.com/free-first-monday-concert-make-out-room-20/',
    city: 'Make-Out Room',
  ...
  { name: { text: 'Beatles Karaoke Night ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2011/06/beatles-1964-175x130.jpg' },
    venue: { name: ' The Royale ' },
    url: 'http://sf.funcheap.com/beatles-karaoke-night-trendynob-31/',
    city: 'Trendynob',
    date: 'Monday, November 2 – 8:00 pm',
    cost: 'FREE' },
  { name: { text: 'Open Mic Night in a Movie Theater ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2014/01/1526386_714991918525167_244336727_n-175x130.jpg' },
    venue: { name: ' The New Parkway ' },
    url: 'http://sf.funcheap.com/open-mic-night-in-a-movie-theater-the-new-parkway-5/',
    city: 'The New Parkway',
    date: 'Monday, November 2 – 8:45 pm',
    cost: 'FREE' },
  { name: { text: 'Wood Shoppe Free Concert Series ' },
    description: { text: 'Wood Shoppe is a free monthly music series at Brick & Mortar Music Hall taking place every first Tuesday of the month. Get exposed to local and national emerging artists without the pressure of a cover charge. $3 Trumer Pils and $5 Sailor Jerry cocktails ...' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2012/10/brick-and-mortar-concert-175x130.jpg' },
    venue: { name: ' Brick & Mortar Music Hall ' },
    url: 'http://sf.funcheap.com/wood-shoppe-free-concert-series-brick-mortar-30/',
    city: 'Brick & Mortar',
  ...
  { name: { text: 'South First Fridays Art Walk ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2012/10/sofa-first-friday-175x130.jpg' },
    venue: { name: ' SoFA District (San Jose) ' },
    url: 'http://sf.funcheap.com/south-first-fridays-art-walk-san-jose-30/',
    city: 'San Jose',
  ...
  { name: { text: 'Sea Chantey Sing Along Aboard Historic Ship ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2011/08/Playing-Guys-175x130.gif' },
    venue: { name: ' SF Maritime National Historical Park ' },
    url: 'http://sf.funcheap.com/sea-chantey-sing-along-aboard-historic-ship-sf-26/',
    city: 'San Francisco',
  ...
  { name: { text: 'Push The Feeling DJ Night ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2012/11/push-the-feeling-175x130.png' },
    venue: { name: ' Underground SF ' },
    url: 'http://sf.funcheap.com/push-the-feeling-dj-night-lower-haight-29/',
    city: 'Lower Haight',
  ...
  { name: { text: 'Shapeshifters Cinema: Experimental Film & Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/07/shapeshifters-175x130.jpg' },
    venue: { name: ' Temescal Art Center ' },
    url: 'http://sf.funcheap.com/shapeshifters-cinema-experimental-film-music-oakland-27/',
    city: 'Oakland',
  ...
  { name: { text: 'Wheel of Karaoke: Comedy & Music Battle ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2014/06/KJpaulcostumekaraoke-175x130.jpg' },
    venue: { name: ' Make-Out Room ' },
    url: 'http://sf.funcheap.com/wheel-of-karaoke-comedy-music-battle-make-out-room-14/',
    city: 'Make-Out Room',
  ...
  { name: { text: '“She Rocks” Live Music, Comedy & Drag Showcase ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/01/joan-jett-1-175x130.jpg' },
    venue: { name: ' The Fireside Lounge ' },
    url: 'http://sf.funcheap.com/she-rocks-live-music-comedy-drag-showcase-sf-10/',
    city: 'San Francisco',
  ...
  { name: { text: 'Downtown Campbell Second Saturdays: Music, Art & Food' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/11/campbell-175x130.jpg' },
    venue: { name: ' Downtown Campbell ' },
    url: 'http://sf.funcheap.com/downtown-campbell-second-saturdays-music-art-food-24/',
    city: undefined,
  ...
  { name: { text: 'Hardly Strictly Tribute Concert Series ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/06/Screen-Shot-2015-06-17-at-9.15.30-PM-175x130.png' },
    venue: { name: ' Contemporary Jewish Museum ' },
    url: 'http://sf.funcheap.com/hardly-strictly-tribute-concert-series-contemporary-jewish-museum-4/',
    city: 'Contemporary Jewish Museum',
  ...
  { name: { text: '“3rd On Third” Arts & Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/06/bayview-mural-175x130.png' },
    venue: { name: ' Bayview Opera House ' },
    url: 'http://sf.funcheap.com/3rd-on-third-arts-music-bayview-23/',
    city: 'Bayview',
  ...
  { name: { text: 'Sunday Assembly: Communty Sing & Meetup ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2014/03/SA_FB_Cover_Wonder_Audience1-175x130.jpg' },
    venue: { name: ' Oakland Peace Center ' },
    url: 'http://sf.funcheap.com/sunday-assembly-communty-sing-meetup-oakland-4/',
    city: 'Oakland',
  ...
  { name: { text: 'Free Vegetarian Dinner Night ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/12/volxkuche-175x130.jpg' },
    venue: { name: ' St. John Episcopal Church ' },
    url: 'http://sf.funcheap.com/free-vegetarian-dinner-night-sf-22/',
    city: 'San Francisco',
  ...
  { name: { text: 'Feral Fourth Fridays Urban Square Dance & Live Music ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2015/01/nat_geo__0706_shall_we_dance-175x130.jpg' },
    venue: { name: ' Alley Cat Books ' },
    url: 'http://sf.funcheap.com/feral-fourth-fridays-urban-square-dance-live-music-sf-9/',
    city: 'San Francisco',
  ...
  { name: { text: 'The Beatles Choir: Volunteer Singalong ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/12/beatles-choir-175x130.jpg' },
    venue: { name: ' Laguna Honda Hospital ' },
    url: 'http://sf.funcheap.com/the-beatles-choir-volunteer-singalong-sf-20/',
    city: 'San Francisco',
    date: 'Saturday, November 28 – 9:30 am',
    cost: 'FREE' },
  { name: { text: 'Mixed Media Mixer: Art, Music, Photo & Video Showcase ' },
    description: { text: 'The Mixed Media Mixer is a monthly event with the goal of bringing artists across many platforms together with the intention of collaboration. A new collection of Bay Area artists, musicians, photographers and videographers come together every last Sunday of the month at the Firehouse Art Events Hangar. Bring ...' },
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2013/11/arts-hangar-175x130.jpg' },
    venue: { name: ' Firehouse Art Collective ' },
    url: 'http://sf.funcheap.com/mixed-media-mixer-art-music-photo-video-showcase-berkeley-23/',
    city: 'Berkeley',
  ...
  { name: { text: 'Free Lunchtime Concert: Holiday Concert 2015 ' },
    ...
    url: 'http://sf.funcheap.com/free-lunchtime-concert-holiday-concert-2015-oakland/',
    city: 'Oakland',
  ...
  { name: { text: 'Open Mic Night in a Movie Theater ' },
    ...
    logo: { url: 'http://cdn.funcheap.com/wp-content/uploads/2014/01/1526386_714991918525167_244336727_n-175x130.jpg' },
    venue: { name: ' The New Parkway ' },
    url: 'http://sf.funcheap.com/open-mic-night-in-a-movie-theater-the-new-parkway-6/',
    city: 'The New Parkway',
    date: 'Monday, December 7 – 8:45 pm',
    cost: 'FREE' } ];
